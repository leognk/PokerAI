...
// Same as FastRandomChoice but with no need to have the sum
// of the weights to be equal to RANGE. However, the random number
// generated by the rng will be rescaled each time a random
// choice is made. Thus, this class is to be used when the weights
// change a lot compared to the number of times a random choice is made.
template<unsigned tBits = 16>
