...
int main()
{
	...
	//std::array<uint8_t, 3> u1 = { 3, 0, 0 };
	//std::array<uint8_t, 3> u2 = { 0, 3, 0 };
	//std::array<uint8_t, 3> u3 = { 0, 0, 3 };
	std::array<std::array<uint8_t, 5>, 3> data = { u1, u2, u3 };
	std::array<uint8_t, 5> center;
