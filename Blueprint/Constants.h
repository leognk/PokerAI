...
#define MEDIUM_BLUEPRINT_2 2
#define MEDIUM_BLUEPRINT_1 1
...
#elif MACRO_BLUEPRINT_NAME == MEDIUM_BLUEPRINT_2
...
static const std::string BLUEPRINT_NAME = "MEDIUM_BLUEPRINT_2";
...
#elif MACRO_BLUEPRINT_NAME == MEDIUM_BLUEPRINT_1
...
static const std::string BLUEPRINT_NAME = "MEDIUM_BLUEPRINT_1";
